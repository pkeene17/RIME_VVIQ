...
if dbgn == 1 % debugging
    ...
    stimTime            = .5;
    fixTime             = .05;
    wordtime            = .05; %added by FRR
    pictime             = .05; %added by FRR
    vividStimTime       = 1;%.01;
    vividRedBoxTime     = 1; 
    feedbacktime        = 3;
    endblocktime        = 3;
...
%   stimTime            = 4;
    ...
    oddevenFix          = 1.5;
    oddevenBetween      = 1;
    oddevenrepeats      = 2; %how many times the odd/even task repeats
end
...
addpath('/Users/kuhllabmanager/Desktop/RIME_fMRI/SCRIPTS/stim');

 oddkey =  '6^';                 %***ask avi whether this is correct
 evenkey = '7&';
