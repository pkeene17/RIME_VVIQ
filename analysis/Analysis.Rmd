...
exclude_subj=c(34,35,36,37,38,39,40)#c(3,6,10,12,24,34,35,36,37,38,39,40,59,61) #I fucked up updating the code. 
...
stim_dprimedf[stim_dprimedf$retrieval=="retrieved",] %>%
...
dprimedf %>% ggscatter(x='fadiff',y='VVIQ',add='reg.line',cor.coef=TRUE,cor.method='pearson',title='FA-VVIQ score correlation')

dprimedf %>% ggscatter(x='ddiff',y='VVIQ',add='reg.line',cor.coef=TRUE,cor.method='pearson',title='dprime-VVIQ score correlation')

dprimedf %>% ggscatter(x='hrdiff',y='VVIQ',add='reg.line',cor.coef=TRUE,cor.method='pearson',title='HR-VVIQ score correlation')
```